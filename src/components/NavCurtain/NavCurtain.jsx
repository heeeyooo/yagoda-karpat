...
const NavCurtain = () => {
    ...
    const changeToUa = () => {
        ...
        document.querySelector(".chanterelle-product").innerHTML =
            "Гриб лисичка";
        ...
        document.querySelector(".certificate-info").innerHTML =
            "Наші сертифікати";
    };
    ...
    const changeToEn = () => {
        ...
        document.querySelector(".lingonberry-product").innerHTML =
            "Lingonberry";
